...
import lightPageNotFoundImg from '@/img/404-light.png';
import darkPageNotFoundImg from '@/img/404-dark.png';
import lightFullLogo from '@/img/aws-light.svg';
import darkFullLogo from '@/img/aws-dark.png';
